...
public class ProfilePoint {
    ...
    public ProfilePoint(double x, double y, double x_l, double y_l, double x_r, double y_r, double leftDistance, double rightDistance, double leftSpeed, double rightSpeed) {
        this.x = x;
        this.y = y;
